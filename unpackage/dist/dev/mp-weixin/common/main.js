...
/* 0 */
/*!*******************************************************!*\
  !*** D:/Backup/桌面/历史项目/scanCode0531/scanCode/main.js ***!
  \*******************************************************/
...
_vue.default.prototype.$eventHub = new _vue.default();var loading = function loading() {__webpack_require__.e(/*! require.ensure | components/loading */ "components/loading").then((function () {return resolve(__webpack_require__(/*! ./components/loading.vue */ 478));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
...
/* 5 */
/*!*******************************************************!*\
  !*** D:/Backup/桌面/历史项目/scanCode0531/scanCode/App.vue ***!
  \*******************************************************/
/*! no static exports found */
...
component.options.__file = "Backup/桌面/历史项目/scanCode0531/scanCode/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),
/* 6 */
/*!********************************************************************************!*\
  !*** D:/Backup/桌面/历史项目/scanCode0531/scanCode/App.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  onLaunch: function onLaunch(e) {
    ...
    var uid = this.$api.getStorage("kejia_order_uid");
    var userInfo = this.$api.getStorage("kejia_order_userInfo");
    var shopId = this.$api.getStorage("kejia_order_shopId");
    // debugger ;
    if (shopId) {
  ...
  (0, _vuex.mapMutations)(['intoShop', 'intoDesk', 'login', 'changeNeedScan']), {

    // 程序启动扫码进入，获取店铺id和桌号id
    onStartupScene: function onStartupScene(query) {
      if (!query) {return;}
      var pathStr = '';
      var path = decodeURIComponent(query);
      var _this = this;
      if (path.indexOf('%') != -1) {
        var ss = _this.$api.getParam(path, 'scene'); //提取参数
        var scenes = decodeURIComponent(ss);
        pathStr = 'pages/xxx?' + scenes;
      } else {
        pathStr = path.replace('scene=', '');
      }
      var uniacid = _this.$api.getParam(pathStr, 'uniacid');
      var shop_id = _this.$api.getParam(pathStr, 'shop_id');
      var desk = _this.$api.getParam(pathStr, 'desk');
...
/* 9 */
/*!****************************************************************************************!*\
  !*** D:/Backup/桌面/历史项目/scanCode0531/scanCode/App.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
